...
## Type
Manrope is the workhorse sans for navigation and body copy. DM Mono is used for metadata, indexes, and utility labels. Georgia is used sparingly for italic editorial contrast. Display type is fluid with a negative tracking value and compact line-height.
